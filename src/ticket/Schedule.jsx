    ...
    return (
        <li>
            ...
            >
                ...
                >
                    {isStartStation ? 'Start' : arriveTime}
                </span>
                <span
    ...
    return (
        ...
        <div className="dialog">
            ...
            <div className="head">
                ...
                <span className="deptime">Arrive Time</span>
                <span className="arrtime">Depart Time</span>
                <span className="stoptime">Stay Time</span>
            </div>
            <ul>
